...
Now that we know the differences in how pvalues and confidence intervals, hopefully it is also clear to you that the conclusions we can draw from confidence intervals are very much different from what we can from a p-value. A p value only tells us the probability of obtaining the sample result if the null hypothesis were true.
