...
- Caused by factors that effect a measurement in an **unpredictable** way

--

<img src="scales.png" height="300px" width="auto">
...
- Caused by factors that effect a measurement in a **predictable** way

- Systematic errors may be able to be **corrected** 
...
- True value
- Observed value
- Error value (Random + systematic error)

--

Observed value = True value + Error *or*
