...
Now instead imagine that we've flipped one thousand coins ten thousand times. Now the distribution of heads is centered around 500. Notice the distribution is now taking on a sort of symmetrical bell curve shape. This is because when you draw from a binomial with a very large size, that is, many coin flips, the result approximates a normal distribution. This normal distribution is famous because many distributions in nature take this shape, including measurement errors in scientific experiments, which we learned about last week. Most of the common statisical analysis methods you'll come across in quantitative nursing research studies are based on the normal distribution. 
