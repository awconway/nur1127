...
#### Formation of a core team at each site, who lead the implementation by: 
...
3) using a structured local barrier identification and mitigation tool; and 
...
4) using Plan-Do-Study-Act cycles (which were taught at the workshops) to guide the actual implementation. 
...
#### Multi-site pre and post-implementation design (Duff et al., 2018)

#### Increased use of active warming (difference 14.3%; 95% CI=5.5%–23.2%)
