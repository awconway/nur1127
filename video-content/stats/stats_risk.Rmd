...
- Difference between the event rates in the two groups
...
- the difference in event rates between two groups, expressed as a proportion of the event rate in the control group
...
### RR > 1 = *increase* in risk of outcome with each unit *increase* in the predictor

### RR < 1 = *decrease* in risk of outcome with each unit *increase* in the predictor
...
### Understanding the difference between these effect estimates is vital for decision-making

- If a patient is told that a new treatment reduces their risk of dying by twenty percent (the relative risk reduction), they may make a different decision to the one they would make when told that the new treatment reduces their risk of dying by five percent. 

- Especially if there are other harms associated with the treatment they would need to tolerate.
