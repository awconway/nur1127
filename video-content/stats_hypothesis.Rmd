...
In simple terms, the goal for hypothesis testing using statistical inference is to DISPROVE the null hypothsis so that you can claim the alternative hypothesis is true. So how are we going to do that. Let's go through the steps in the next video now.
