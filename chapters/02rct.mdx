...
import SofTable from '../src/components/sofTable.js'
...
controlled trials is the [Cochrane risk of bias tool](https://www.riskofbias.info/welcome/rob-2-0-tool). Please take a moment to
...
ℹ️ [Risk of bias assessment guidance for cluster randomized trials](https://www.riskofbias.info/welcome/rob-2-0-tool/rob-2-for-cluster-randomized-trials)


📁 A blank copy of the excel spreadsheet that was used in the webinar
to undertake risk of bias assessments for **cluster**-randomized controlled trials can be
downloaded <a href="https://drive.google.com/uc?export=download&id=1MP1yDea4Ry488A5BXeP0mrvrcORz6UgG">here</a>
for your future use.

📁 A copy of the completed excel spreadsheet that I used in the
webinar can be downloaded
[here](attachments/ROB2_cluster_Johnson_2019.xlsm). From
the 'Intro' tab, press "RoB 2 Assessment Form" to open the pop-up window.


📁 A copy of the article with some of my notes from the webinar can be downloaded [here](attachments/Johnson_2019.pdf).

<!-- Access
[Zoom](https://utoronto.zoom.us/j/81113978336)
for the webinar to be held on Tuesday 18th January at 12md. -->

<iframe src="https://player.vimeo.com/video/667406016?h=45f1b75720&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen width="100%" height="550px" title="rob_cluster"></iframe>
